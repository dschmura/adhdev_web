...
class AccountInvitationDashboard < Administrate::BaseDashboard
  ...
  # Overwrite this method to customize how account invitations are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(account_invitation)
  #   "AccountInvitation ##{account_invitation.id}"
  # end
end
